package net.etri.rest.api.xml.web;
...
import net.etri.rest.api.xml.Connections;
import net.etri.rest.api.xml.Edges;
import net.etri.rest.api.xml.Nodes;
import net.etri.rest.api.xml.TlLogic;
import net.etri.rest.api.xml.TlLogics;
import net.etri.rest.api.xml.XmlController;
import net.etri.rest.api.xml.XmlManager;

/**
  <p>클래스 설명 : </p>
  <p>XmlFileController</p>
  <pre>
   net.etri.rest.api.xml.web
...
Logger log = LoggerFactory.getLogger(XmlController.class);
	...
	*/
	...
	public void filterTlXml(MultipartFile uploadFile, HttpServletResponse response) throws IOException, JAXBException {
		...
		RequestVO req = new RequestVO(IncludeType.TSS, "", "", "", "", "11250", "", 1, true, RouteType.NOT_INCLUDE, false, false, false, RequestType.SCENARIO_REGION);
