...
@XmlType(propOrder={"id", "from_node", "to_node", "priority", "numLanes", "speed", "shape", "spreadType", "dong_cd", "edge_len", "left_pocket", "right_pocket", "blanest" })
...
public class Edge {
	...
	*/
	...
	@XmlAttribute(name = "blanest")
	private int blanest = 0;
