...
public class RequestVO extends DefaultVO {
	...
	private boolean busstop_yn; //20211115 장길수 추가
	...
	*/
	...
	/**	  
	 ...
	 @param busstop_yn 버스정류소포함여부 20211115 장길수 추가
	...
	*/
	public RequestVO(IncludeType include, String req_date, String toDate, String fromTime, String toTime, 
			 			...
			 			boolean event_yn, boolean weather_yn, boolean busstop_yn, RequestType requestType){
	...
	*/
	public RequestVO(IncludeType include, String req_date, String toDate, String fromTime, String toTime,
						...
						RouteType route, boolean event_yn, boolean weather_yn, boolean busstop_yn, RequestType requestType){
		this.include = include;
		this.req_date = req_date;
		this.from_date = req_date;
		this.to_date = toDate;
	...
	*/
	...
	/**
    @return the busstop_yn
	*/
	public boolean isBusstop_yn() {
		return busstop_yn;
	}
	/**
 	 @param busstop_yn the busstop_yn to set
	*/
	public void setBusstop_yn(boolean busstop_yn) {
		this.busstop_yn = busstop_yn;
	}
	...
	*/
	...
	/* (non-Javadoc)
	 @see net.etri.rest.api.service.DefaultVO#toString()
	*/
	@Override
