...
//@XmlType(propOrder={"phaseSignalDefault", "schedule", "TODPlan", "nodeID", "version", "crossNo", "crossName", "date", "signalGroup"})
...
public class TrafficSignal {
	...
	/////////////////////////////////////////////////////////
//	@XmlElement(name="phaseSignalDefault")
//	private List<TrafficSignalTime> phaseSignalDefault = null;
	/////////////////////////////////////////////////////////
...
//	}
	...
	*/
	public TrafficSignal(Signal signal ){
		...
		if( signal.getSchedule() != null && !signal.getSchedule().isEmpty() ){
			this.schedule = new ArrayList<TrafficSignalScenario>(); 
			setSignalSchedule(signal.getSchedule(), signal.getSignalTime());
		}
		
	
//		if( signal.getSignalTime() != null && !signal.getSignalTime().isEmpty() ){
//			this.phaseSignalDefault = new ArrayList<TrafficSignalTime>(); 
//			setSignalTime(signal.getSignalTime());
//		}
	...
	/**
	 @param schedule the schedule to set
	*/
	private void setSignalSchedule(List<SignalScenario> scenario, List<SignalTime> signalTime){
		// TODO : Signal객체를 통해 TrafficSignal객체로 전환시  신호 XML 생성에 필요한 스케줄 처리
		if( scenario == null || scenario.isEmpty() )
			return;
		...
		while(it.hasNext()){
			...
			try {
				this.schedule.add( new TrafficSignalScenario(s.getPattern_id(),
					s.getPeristalsis(), s.getPhase(), signalTime)  );
			}catch(Exception e) {
				e.printStackTrace();
			}
		}
	...
	/**
	 @param schedule the schedule to set
	*/
//	private void setSignalTime(List<SignalTime> signaltime){
//		
//		if( signaltime == null || signaltime.isEmpty() )
//			return;
//		
//		this.phaseSignalDefault.add( new TrafficSignalTime(signaltime) );
//
//		
//	}
	
	
//	public List<TrafficSignalTime> getTrafficSignalTime() {
//		return phaseSignalDefault;
//	}
//
//	
//	public void setTrafficSignalTime(List<TrafficSignalTime> phaseSignalDefault) {
//		this.phaseSignalDefault = phaseSignalDefault;
//	}
