							...
							<div class="panel-body">
								<div class="form-group">
									...
									<div class="form-group">
									    ...
									    <span class="button-checkbox">
									        <button type="button" class="btn input-sm" style="width: 90px;" data-color="primary">버스포함</button>
									        <input type="checkbox" class="hidden" id="busstop" name="busstop" checked="checked" />
									    </span>
										<input type="number" class="hidden" id="bydong" name="bydong"  />
										<input class="btn input-sm btn-primary" type="button" value="요청" onclick="javascript:RequestScenarioByCoordinate(0);" >
										<input class="btn input-sm btn-primary" type="button" value="동기반 요청" onclick="javascript:RequestScenarioByCoordinate(1);" >
									</div>
							...
							<div class="panel-body">
								<div class="form-group">
									...
									<div class="form-group">
										...
										<span class="button-checkbox">
									        <button type="button" class="btn input-sm" style="width: 60px;" data-color="primary">신호</button>
									        <input type="checkbox" class="hidden" id="signal" name="signal" checked="checked" />
									    </span>		
									    <span class="button-checkbox">
									        <button type="button" class="btn input-sm" style="width: 60px;" data-color="primary">버스</button>
									        <input type="checkbox" class="hidden" id="busstop" name="busstop" checked="checked" />
									    </span>
      ...
      <div class="modal-content"> 
        ...
        <p>
        	<div class="row" style="margin-bottom: 12px;">
				...
				<input class="btn btn-primary" type="button" value="Send" id="signalJsonFileUpload" role="upload" data-target="signalJsonFile" data-url="../restapi/updateSignalFile" onclick="UploadJson(this);">
			</div>
