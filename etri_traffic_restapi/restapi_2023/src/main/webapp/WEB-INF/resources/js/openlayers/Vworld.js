...
var VworldHybrid = new ol.source.XYZ({
    url: 'http://api.vworld.kr/req/wmts/1.0.0/D5309063-9A24-3D18-B28B-673B8F9FD6EE/Hybrid/{z}/{y}/{x}.png'
}); //문자 타일 레이어
 
var VworldSatellite = new ol.source.XYZ({
    url: 'http://api.vworld.kr/req/wmts/1.0.0/D5309063-9A24-3D18-B28B-673B8F9FD6EE/Satellite/{z}/{y}/{x}.jpeg'
    ,attributions : attr
}); //항공사진 레이어 타일
 
    var VworldBase = new ol.source.XYZ({
        url: 'http://api.vworld.kr/req/wmts/1.0.0/D5309063-9A24-3D18-B28B-673B8F9FD6EE/Base/{z}/{y}/{x}.png'
    ,attributions : attr
}); // 기본지도 타일
 
    var VworldGray =  new ol.source.XYZ({
        url: 'http://api.vworld.kr/req/wmts/1.0.0/D5309063-9A24-3D18-B28B-673B8F9FD6EE/gray/{z}/{y}/{x}.png'
    ,attributions : attr
}); //회색지도 타일
 
var VworldMidnight =  new ol.source.XYZ({
    url: 'http://api.vworld.kr/req/wmts/1.0.0/D5309063-9A24-3D18-B28B-673B8F9FD6EE/midnight/{z}/{y}/{x}.png'
    ,attributions : attr
})
